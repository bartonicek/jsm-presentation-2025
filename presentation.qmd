...
## Set union and part-whole relations {.center .middle}

:::{.incremental}
- Set union is the essence of part-whole relations
- The whole should be equal to the "sum" of its parts
- Not more or less
:::

## Part-whole relations and data viz {.center .middle}
...
## If we want to meaningfully combine summaries, they must behave like set union... {.center .middle}

## What does that *really* mean? {.center .middle}

## Set union: Properties {.center .middle .smaller}

- Set union has several mathematical properties
- **Associativity**:
...
- Monoids are a fundamental concept in category theory^[see e.g. @fong2019; @lawvere2009; @milewski2018]
- A monoid $(X, \otimes, e)$ is a tuple consisting of:
  - A set $X$
